...
&= \inf_{\rho>0}\esssup_{(\partial U)^\rho\cap U}\rom{H}_\eps(\cdot, \mathrm D ^{[k]}u).
\end{align*}
...
The content of the following lemma is well known, but we report its proof for seek of completeness.
